...
func createMockIndex(path string) error {
	// Create a more complete mock index structure
	indexData := []byte{
		// Magic number "JAMT"
		0x4A, 0x41, 0x4D, 0x54,
		// Version (1.0)
		...
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		// Sample entry
		0x12, 0x34, 0x56, 0x78, 0x9A, 0xBC, 0xDE, 0xF0, // Hash
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // Position
	}
	return os.WriteFile(path, indexData, 0o644)
}
